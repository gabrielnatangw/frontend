...
// Schema de validação Zod (mesmo da página new.tsx)
...
export default function MachineEditPage() {
  ...
  // Hooks para buscar e atualizar máquina
  ...
  // Preencher formulário quando os dados da máquina carregarem
  useEffect(() => {
    if (machineData?.data) {
  ...
  const onSubmit = async (data: MachineFormData) => {
    ...
    try {
      ...
      console.log('🔄 Dados convertidos para API:', machineData);
      console.log('🔑 Hook updateMachine:', updateMachine);

      // Atualizar máquina via API
      ...
      if (err.response?.data?.errors) {
        ...
        console.log('🔍 Erros de validação da API:', err.response.data.errors);
        showValidationError(err.response.data.errors);
      } else if (err.response?.status === 409) {
        // Conflito (nome/serial já existe)
        console.log('🔍 Conflito detectado (409)');
        showUpdateError('Máquina', error);
      } else if (err.response?.status >= 500) {
        // Erro do servidor
        console.log('🔍 Erro do servidor (5xx)');
        showUpdateError('Máquina', {
        ...
        // Outros erros
        console.log('🔍 Outro tipo de erro:', (error as any).response?.status);
        showUpdateError('Máquina', error);
      }
    }
  };
          ...
          <div className='text-center py-12'>
            <div className='bg-red-50 border border-red-200 rounded-lg p-6'>
              ...
              <p className='text-red-600'>
                Não foi possível carregar os dados da máquina. Tente novamente.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className='flex-1'>
        <form
          onSubmit={handleSubmit(data => {
            console.log('🚨 FORMULÁRIO DE EDIÇÃO SUBMETIDO VIA handleSubmit!');
          ...
          <div className='bg-white border border-zinc-200 rounded-lg h-full flex flex-col'>
            ...
            <div className='px-6 py-6'>
              <Stepper
                ...
                onStepChange={stepIndex => {
                  console.log('🔍 Stepper step change:', stepIndex);
            ...
            <div className='px-6 py-4 border-t border-zinc-200'>
              <div className='flex items-center justify-between'>
                ...
                {/* Lado direito - Botões Voltar e Próximo/Atualizar */}
                <div className='flex items-center gap-3'>
                  ...
                  {currentStep < 2 ? (
                    ...
                    // Botão "Atualizar Máquina" para o passo 2 (submissão do formulário)
                    <Button
                      type='submit'
                      variant='contained'
                      colorScheme='primary'
                      ...
                      onClick={() => {
                        console.log('🔘 BOTÃO ATUALIZAR MÁQUINA CLICADO!');
                      }}
                      className='flex items-center gap-2'
                    >
